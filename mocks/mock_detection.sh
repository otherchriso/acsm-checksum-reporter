...
LOG_LINES[checksum_kick]='time="2026-02-07T08:10:35+10:00" level=info msg="Kicking: CarID: 0, Name: Driver Zero, GUID: 76561100000000001, Model: lotus_evora_gtc, reason: Checksum failed for: content/cars/lotus_evora_gtc/data.acd"'
...
for key in checksum_kick session_closed no_slots plugin_kick ping_kick idle_kick no_join_list; do
  line="${LOG_LINES[$key]}"
  matched=""
