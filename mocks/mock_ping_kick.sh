#!/usr/bin/env bash
# mock_ping_kick.sh
# Mock script to test ping kick template rendering and webhook delivery
...
usage() {
  ...
  echo "  --driver <name>   Driver name to use (default: 'Fernando Alonso')"
  exit 1
}
...
echo "Testing ping_kick template with driver: ${driver}"
echo ""
